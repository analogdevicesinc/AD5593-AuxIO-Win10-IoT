...
This simple Win10 IoT command line tool controls the AD5593R [1], connected via I2C peripheral bus.
...
AuxIO is written in C++ and using the Windows.Devices.I2c WinRT APIs [2] only available on Win10.
It also requires user mode access [3] using the RhProxy driver.

This tool is open source and released under the MIT license [5], it’s source code can be found here [4]
...
[2] https://docs.microsoft.com/en-us/uwp/api/windows.devices.i2c
[3] https://docs.microsoft.com/en-us/windows/uwp/devices-sensors/enable-usermode-access
[4] https://github.com/analogdevicesinc/AD5593-AuxIO-Win10-IoT
